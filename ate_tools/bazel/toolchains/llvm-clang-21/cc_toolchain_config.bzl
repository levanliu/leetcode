                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                ...
                                "-load",
                                "-Xclang",
                                rpmRoot + "llvm-clang-21-plugin/plugins/concurrency-feature-check21.so",
                                "-Xclang",
                                "-add-plugin",
                                "-Xclang",
                ...
                flag_groups = [
                    flag_group(
                        flags = [
                            ...
                            "-L " + rpmRoot + "llvm-clang-21/lib64/x86_64-unknown-linux-gnu",
                            "-Wl,-rpath=" + rpmRoot + "llvm-clang-21/lib64/x86_64-unknown-linux-gnu"
                        ],
                    )
                ]
            ),
